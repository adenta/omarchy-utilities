...
Item {
  ...
  Rectangle {
    ...
    Rectangle {
      id: fill
      width: (root.indeterminate ? 0.25 : Math.max(0, Math.min(1, root.fraction))) * parent.width
      ...
      SequentialAnimation on x {
        ...
        NumberAnimation { from: 0; to: track.width - fill.width; duration: 1000; easing.type: Easing.InOutQuad }
